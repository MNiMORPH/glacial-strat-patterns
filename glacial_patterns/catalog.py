...
FACIES = [
    ...
    ("Sx",  P.sand_xlam,              "cross-laminated sand",    "glaciofluvial",
     "Sand, laminated with sparse cross-bed marks - cross-bedding present"),
    ("Sh",  P.sand_laminated,         "laminated sand",          "glaciofluvial",
     "Sand, horizontally laminated - upper-stage plane beds"),
    ...
    ("Fd",  P.deformed_fines,         "deformed / folded",       "deformation",
     "Folded or contorted laminae - glaciotectonite / soft-sediment deformation"),
    ("SGc", P.collapsed_beds,         "ice-contact (collapsed)", "deformation",
     "Bedded sand faulted into grabens - ice-contact collapse structures"),
...
PROCESS = {
    ...
    "Sx":  "dune/ripple migration; cross-bedding present",
